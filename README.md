...
Целью разработки библиотеки является решение проблем, возникнувших в процессе работы над [проектом](https://github.com/lilac-bud/TurnBasedStrategy-DQN) для магистерской диссертации. В частности, упрощение установки программы на другие компьютеры. Для этого модуль, написанный на языке Python с использованием tensorflow, был переписан в виде представленной библиотеки.
